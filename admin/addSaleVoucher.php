...
if(isset($_POST['sub']))
{
	$obj->add_invoice($_POST['txtdate'],$_POST['txtgate'],$_POST['txtcus'],$_POST['txtwar'],$_POST['txtamt'],$_POST['txtlab'],$_POST['txtpro'],$_POST['txtdis'],$_POST['txttotal'],$_POST['txtmet'],$_POST['txtbal'],$_POST['txtbank'],$_POST['txtacc'],$_POST['txtchq']);
}
															...
															<div class="form-group-row row">
																<div class="col-lg-6 col-sm-12 mb-2">
																	<div class="col-lg-6 col-sm-12 mb-2">
																		...
																		<div>
																			<input name="txtchq" type="text" class="form-control" placeholder="Cheque No" /> </div>
																	</div>
																</div>
															</div>
															<div class="col-lg-6 col-sm-12 mb-2">

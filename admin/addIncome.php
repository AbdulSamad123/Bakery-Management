...
<title>Bakery Software - Admin Add Income</title>
<body>
 ...
 <div class="form-group-row row">
                                               ...
                                               <div class="col-lg-4 col-sm-12 mb-2">
                                                        <label class="form-label">Accont Title</label>
                                                        <div>
                                                            <select class="select2 form-control select2-multiple" multiple="multiple" data-placeholder="Choose ...">
                                                                <optgroup label="Alaskan/Hawaiian Time Zone">
                                                                    <option value="AK">Alaska</option>
                                                    ...
                                                    <div class="col-lg-4 col-sm-12 mb-2">
                                                        ...
                                                        <div>
                                                            <input id="input-mask" class="form-control input-mask" placeholder="Income Title">
                                                        </div>
                                                    </div>
                                  ...
                                  <div class="col-lg-4 col-sm-12 mb-2">
                                                    ...
                                                    <div class="col-lg-4 col-sm-12 mb-2">
                                                        ...
                                                        <div>
                                                            <input id="input-mask" class="form-control input-mask" placeholder="Amount">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-4 col-sm-12 mb-2">
                                                        ...
                                                        <div>
                                                            <input id="input-mask" class="form-control remarks" placeholder="remarks" >
                                                        </div>
                                                    </div>
...
<div class="col-lg-4 col-sm-12 mb-2">
                                                        ...
                                                        <div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input payment-method" type="radio" name="inlineRadioOptions" id="inlineRadio1" value="option1" checked="">
                                                                <label class="form-check-label" for="inlineRadio1">Cash</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input payment-method" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="option2" >

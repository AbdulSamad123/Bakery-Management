...
if(isset($_POST['sub']))
{
	$obj->add_customer($_POST['txtdate'],$_POST['txtname'],$_POST['txtcon'],$_POST['txtbal']);
}

?>
<title>Bakery Software - Admin Register Customer</title>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0">Register Customer</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                                        ...
                                        <form class="custom-validation" autocomplete="off" method="post">
                                                <div class="form-group-row row">
                                                    ...
                                                    <div class="col-lg-6 col-sm-12 mb-2">
                                                        ...
                                                        <div>
                                                            <input name="txtname" type="text" class="form-control" placeholder="Enter Customer" required />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group-row row">

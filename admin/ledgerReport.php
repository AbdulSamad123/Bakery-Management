...
<title>Bakery Software - Admin Ledger Report</title>
<body>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0">Ledger Report</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <form class="custom-validation" action="#">
                                               ...
                                               <div class="col-lg-3 col-sm-12 mb-2">
                                                        <label class="form-label">Accont Title (Customer/Supplier)</label>
                                                        <div>
                                                            <select class="select2 form-control select2-multiple" multiple="multiple" data-placeholder="Choose ...">
                                                                <optgroup label="Alaskan/Hawaiian Time Zone">
                                                                    <option value="AK">Alaska</option>
                                                    ...
                                                    <div class="col-lg-3 col-sm-12 mb-2">
                                                        ...
                                                        <label class="form-label">Select Product (Each Product) </label>
                                                        <select class="select2 form-control select2-multiple" multiple="multiple" data-placeholder="Choose ...">
                                                            <optgroup label="Alaskan/Hawaiian Time Zone">
                                                                <option value="AK">Alaska</option>
                                                                <option value="HI">Hawaii</option>
                                       ...
                                       <div class="col-lg-3 col-sm-12 mb-2">
                                                    ...
                                                    <div class="col-lg-6 col-sm-12 mb-2" style="position: relative;top: 28px;">

...
<title>Bakery Software - Admin Product Amount List</title>
<body>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0">Product Amount List</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title mb-4">Product Amount List</h4>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table price-table" id="price-table" border="1">
                                            ...
                                            <tbody class="list">
                                                <tr id="row_id" data-id="1" class="dynamic_row">
                                                    ...
                                                    <td>
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <input type="number" class=" form-control stock" id="stock" name="stock[]" placeholder="stock" min="1" data-id="1">
                                                                <input type="hidden" name="thisstock[]" class="thisstock" data-id="1">
                                                    ...
                                                    <td colspan="2">
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <input type="number" class=" form-control unit_cost" id="unit_cost" name="unit_cost[]" placeholder="Unit Cost" min="1" data-id="1">
                                                                <input type="hidden" name="cost[]" class="cost" data-id="1" id="cost">
                                                    ...
                                                    <td colspan="2">
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <input type="number" class=" form-control unit_price" id="unit_price" name="unit_price[]" placeholder="Unit Price" min="1">
                                                                <input type="hidden" name="price[]" class="price" data-id="1" id="price">
                                                    ...
                                                    <td>
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <input type="number" class=" form-control total_cost" id="total_cost" name="total_cost[]" readonly placeholder="Total Cost" min="1">
                                            ...
                                            <tr class="dynamic_row" data-id="1">
                                                <td><b>Stock</b></td>
                                                <td>
                                                    <p class="total_stock"><b>0</b></p>
                                                </td>
                                                <td><b>Unit Cost</b></td>
                                                <td>
                                                    <p class="weighted_unit_cost"><b>0</b></p>
                                                </td>
                                                <td><b>Unit Price</b></td>
                                                <td>
                                                    <p class="weighted_unit_price"><b>0</b></p>
                                                </td>
                                                <td><b>Total Cost</b></td>
                                                <td>
                                                    <p class="weighted_total_cost"><b>= 0</b></p>

                                                </td>
                                                <input type="hidden" name="this_stock" class="this-stock">
                                                <input type="hidden" name="this_cost" class="this-cost">
                                                <input type="hidden" name="this_price" class="this-price">
                                                <input type="hidden" name="this_total_cost" class="this-total-cost">
                                                <input type="hidden" name="thiswightedstock" class="thiswightedstock">
                                                <input type="hidden" name="thiswightedcost" class="thiswightedcost">
                                                <input type="hidden" name="thiswightedprice" class="thiswightedprice">
                                                <input type="hidden" name="thiswightedtotalcost" class="thiswightedtotalcost">
                                            </tr>
                                        </table>
                                    </div>

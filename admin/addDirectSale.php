                                        ...
                                        <table class="table price-table" id="price-table" border="1">
                                            ...
                                            <tbody class="list">
                                                <tr id="row_id" data-id="1" class="dynamic_row">
                                                    <td style="width:70px;">
                                                        <input type="text" name="index[]" class="form-control index" value="1" readonly>
                                                    </td>
                                                    <td>
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <input type="date" id="today" class=" form-control stock" id="stock" name="stock[]" placeholder="stock" min="1" data-id="1">
                                                    ...
                                                    <td colspan="2">
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <input type="number" class=" form-control unit_cost" id="unit_cost" name="unit_cost[]" placeholder="" min="1" data-id="1">
